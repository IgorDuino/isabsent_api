...
class Student(SqlAlchemyBase, SerializerMixin):
    ...
    class_name = sqlalchemy.Column(sqlalchemy.String, sqlalchemy.ForeignKey('teachers.class_name'))
    teacher = relationship('Teacher', foreign_keys=[class_name])
    ...
    absents = relationship("Absent", back_populates='student', foreign_keys='Absent.student_id')